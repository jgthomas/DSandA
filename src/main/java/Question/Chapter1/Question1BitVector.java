...
public class Question1BitVector {
   ...
   * TRUE
   *
   * <p>bitVector = 0000 charValue = b - a = 1 = 0001 shiftByValue(0001) = 0010
   *
   * <p>0000 & 0010 = 0000 = 0 = not previously in vector, return true
   *
   * <p>FALSE
   *
   * <p>bitVector = 0010 charValue = b - a = 1 = 0001 shiftByValue(0001) = 0010
   *
   * <p>0010 & 0010 = 0010 = 2 = already in vector, return false
   */
  ...
  /**
   * bitVector = 0000 charValue = b - a = 1 = 0001 shiftByValue(0001) = 0010
   *
   * <p>0000 | 0010 = 0010
   *
   * <p>bit is now set
  ...
  /** value = 1 = 0001 1 = 0001 0001 << 1 = 2 = 0010 */
