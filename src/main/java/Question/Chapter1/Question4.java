...
public final class Question4 {
  ...
  /**
   * Even length strings require an even number of each character to be a palindrome.
   *
   * <p>Odd length strings can have one character appear an odd number of times, but the other
   * characters must appear an even number.
   */
