...
public class ResizeableArrayTest {
  ...
  void testExceptionOutOfBoundsPutEmpty() {
    ResizeableArray<Integer> resizeableArray = new ResizeableArray<>(8);
    assertThrows(IndexOutOfBoundsException.class, () -> resizeableArray.put(8, 10));
  }

  @Test
  void testExceptionOutOfBoundsGetEmpty() {
    ResizeableArray<Integer> resizeableArray = new ResizeableArray<>(8);
    assertThrows(IndexOutOfBoundsException.class, () -> resizeableArray.get(8));
  }
  ...
  void testExceptionOutOfBoundsPutBeyondLogicalSize() {
    ...
    assertThrows(IndexOutOfBoundsException.class, () -> resizeableArray.put(12, 10));
  }
  ...
  void testExceptionOutOfBoundsPutAtLogicalSize() {
    ...
    assertThrows(IndexOutOfBoundsException.class, () -> resizeableArray.put(10, 40));
  }
  ...
  void testExceptionOutOfBoundsGetBeyondLogicalSize() {
    ...
    assertThrows(IndexOutOfBoundsException.class, () -> resizeableArray.get(12));
  }
  ...
  void testExceptionOutOfBoundsGetAtLogicalSize() {
    ...
    assertThrows(IndexOutOfBoundsException.class, () -> resizeableArray.get(10));
  }
}
